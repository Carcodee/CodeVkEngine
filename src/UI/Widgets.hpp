    ...
    namespace Nodes
    {
        ...
        struct ScrollableInfo
        {
            ...
            struct MultiOptionInfo
            {
                ...
                MultiOptionInfo(std::vector<std::string> options, std::map<int ,TextInputInfo> inputTexts,
            ...
            struct GraphNodeFactory
            {
                ...
                GraphNode GetNode(NodeType nodeType, glm::vec2 pos = glm::vec2(0.0), std::string name = "")
                {
                    ...
                    case N_SHADER:
                        ...
                        std::map<int, SelectableInfo> selectables;
                        selectables.try_emplace(1, SelectableInfo{"Shader Types", {"Vertex", "Fragment", "Compute"}});
                        
                        
                        MultiOptionInfo multiOptionInfo("Shader Options", options, textInputs, selectables, scrollables, {})
                        builder
                            .SetNodeId(NextID(), "Shader Node")
                            .AddMultiOption()
                            .AddScrollableOption(NextID(), {"Posible Shaders", PrimitiveNodeType::STRING, shaderPaths})
                            .AddTextInput(NextID(), {"Img Name", "Image Name"})
                            .AddOutput(NextID(), {"Shader result", N_SHADER});
                        break;
                    }
