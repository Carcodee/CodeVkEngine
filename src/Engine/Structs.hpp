...
struct AttachmentInfo : SYSTEMS::ISerializable<AttachmentInfo>
{
	...
	nlohmann::json Serialize() override
	{
		nlohmann::json j = nlohmann::json{
		    ...
		    {
		        "attachmentInfo", {// Store as uint64_t for safety
		                           ...
		                           {"clearValue", {this->attachmentInfo.clearValue.color.float32[0], this->attachmentInfo.clearValue.color.float32[1], this->attachmentInfo.clearValue.color.float32[2], this->attachmentInfo.clearValue.color.float32[3]}}}}};
		return j;
	}
